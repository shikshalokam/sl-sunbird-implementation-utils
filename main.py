    ...
    for sheetEnv in sheetNames:
        if sheetEnv.strip().lower() == 'details':
            ...
            for row_index_env in range(2, detailsEnvSheet.nrows):
                ...
                programPresent = getProgramInfo(accessToken, parentFolder, programNameInp.encode('utf-8').decode('utf-8'))
...
def mainFunc(MainFilePath, addObservationSolution, millisecond, scopeEntityType=scopeEntityType):
    ...
    # accessToken = "eyJhbGciOiJSUzI1NiIsInR5cCIgOiAiSldUIiwia2lkIiA6ICJwMTRYR1lrdHAxUnNScEZZeXZGTnZuekUxVDBMT3hVSHBoNnhHSzUxdGhvIn0..T-9mFr5yzwkgGt5putOxaizwWx0QLWfG_mfnie2wROFNbXkCODQ7d3qIdOOhdEQzgm_4bQdDEyf7tqj8yQhLZGS5bFm3ukF0Xwu8YK6JVr70tEbdhQEHiwJ4JUSTXRvtVrinKIigug_50fbAsArkx38Axb6jSKCYl1GnngfyTzZweHMccNAHdlvars_fn9kdygb6FGY-dbp4uGFD8UGri4dOGgJYvs8TWEri2Bf2vr490Iyqp1JW3ifwnLM6h_1dBnaQrLlmjwgWpyfabsnORWA0Xj3F7gD6UimDOWZ0QajwE86Iz10E4luW0c-R9CuMHW6bUF6bOA59Dt9l52PqRQ"
...
# programFile = argument.resourceFile
resourceFile = "sur1.xlsx"
environment = "dev"
